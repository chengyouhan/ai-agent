...
pages = {
    "Studio": [
        ...
        st.Page(str(SHELL_ROOT / "pages" / "4_Order_App.py"), title="點餐 App"),
        st.Page(str(SHELL_ROOT / "pages" / "5_Shooting_Game.py"), title="射擊遊戲"),
        st.Page(str(SHELL_ROOT / "pages" / "6_AI_Defense_Lab.py"), title="AI 防護實驗室"),
    ],
}
